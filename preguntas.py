...
def lambda_handler(event, context):
    ...
    NEW_QUESTION_TWELVE = {
        "requests": [{
            "createItem": {
                "item": {
                    "title": "Sugerencia, reclamo o comentarios",
                    "questionItem": {
                        "question": {
                            "required": False,
                              "textQuestion": {                    
    ...
    NEW_QUESTION_TEN = {
        "requests": [{
            "createItem": {
                "item": {
                    "title": "La facturación se realizó dentro de los plazos y cumpliendo las formas acordadas",
                    "questionItem": {
                        "question": {
                            "required": True,
                            "scaleQuestion": {
    ...
    NEW_QUESTION_EIGHT = {
        "requests": [{
            "createItem": {
                "item": {
                    "title": "La relatoría tuvo una buena recepción por parte de los usuarios",
                    "questionItem": {
                        "question": {
                            "required": True,
                            "scaleQuestion": {
    ...
    NEW_QUESTION_SEVEN = {
        "requests": [{
            "createItem": {
                "item": {
                    "title": "El equipo de soporte resolvió oportunamente problemas de acceso, cuando fue requerido",
                    "questionItem": {
                        "question": {
                            "required": True,
                            "scaleQuestion": {
    ...
    NEW_QUESTION_FIVE = {
        "requests": [{
            "createItem": {
                "item": {
                    "title": "Se proporcionaron los contactos del personal de operaciones y canales de comunicación para soporte",
                    "questionItem": {
                        "question": {
                            "required": True,
                            "scaleQuestion": {
    ...
    form_service.forms().batchUpdate(formId=result["formId"], body=NEW_QUESTION_NINE).execute()
    form_service.forms().batchUpdate(formId=result["formId"], body=NEW_QUESTION_EIGHT).execute()
    form_service.forms().batchUpdate(formId=result["formId"], body=NEW_QUESTION_SEVEN).execute()
